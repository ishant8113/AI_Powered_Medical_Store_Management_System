...
import Customer,Inventory,Reports,Supplier,Billing,Admin_feature
...
class MedicalStoreApp:
    def __init__(self):
        ...
        self.w.iconbitmap(r"medical_store_project\Assets\logo.ico")
        # Set window icon
        icon_img = Image.open(r"medical_store_project\Assets\image_2.png")
    ...
    def admin_feature(self):
        Admin_feature.admin_feature(self)
    ...
    def dele(self):
        if self.f1:
            self.f1.destroy()
            icon_img = Image.open(r"medical_store_project\Assets\open.png")
    ...
    def toggle_win(self):
        if self.f1:
            ...
            lb1.place(x=575, y=0)
            lb2 = CTkLabel(self.w, text="( A D M I N )", bg_color='#262626', font=("Microsoft JhengHei UI Bold",28, "bold"),text_color="#12c4c0")
            lb2.place(x=1000,y=5)
            img1 = Image.open(r"medical_store_project\Assets\image_2.png")
            ...
            global img2
            img2 = ImageTk.PhotoImage(Image.open(r"medical_store_project\Assets\close.png"))
            Button(self.f1,
                image=img2,
                border=0,
                command=self.dele,
    ...
    def run(self):
        # Open the image
        image = Image.open(r"medical_store_project\Assets\open.png")
